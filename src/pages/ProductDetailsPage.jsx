...
import { ArrowLeft, Star, Heart, ShoppingBag, Truck, ShieldCheck, Clock } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
            ...
            >
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button className="flex-1 bg-white border-2 border-brand-primary text-brand-primary font-bold py-4 px-8 rounded-xl hover:bg-brand-light transition-colors">
                  Add to Cart
                </button>
              </div>
